        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false),
                    Identifier = table.Column<string>(type: "text", nullable: false),
                    AttackMultiplier = table.Column<double>(type: "double precision", nullable: false),
                    DefenseMultiplier = table.Column<double>(type: "double precision", nullable: false),
                    SpecialAttackMultiplier = table.Column<double>(type: "double precision", nullable: false),
                    SpecialDefenseMultiplier = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PkmnTypeId = table.Column<int>(type: "integer", nullable: false),
                    DamageClassId = table.Column<int>(type: "integer", nullable: false),
                    MoveEffectId = table.Column<int>(type: "integer", nullable: true),
                    MoveEffectChance = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeraPkmnTypeId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    HPEV = table.Column<int>(type: "integer", nullable: false),
                    AttackEV = table.Column<int>(type: "integer", nullable: false),
                    DefenseEV = table.Column<int>(type: "integer", nullable: false),
                    SpecialAttackEV = table.Column<int>(type: "integer", nullable: false),
                    SpecialDefenseEV = table.Column<int>(type: "integer", nullable: false),
                    SpeedEV = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "715ea566-da75-4eb2-8ae9-a9bc4fcce567", null, "Admin", "ADMIN" },
                    { "8cb44501-4b2b-4d84-8478-dd7bfe361607", null, "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "test1", 0, "d906ac19-07fb-4628-9b04-f2d4fa2f2256", null, false, false, null, null, null, null, null, false, "f24ce601-d425-4f54-a193-671d50dfa851", false, "TestUser1" },
                    { "test2", 0, "9a57d2c7-5210-4b55-abfc-5c52f9d11e3d", null, false, false, null, null, null, null, null, false, "cf572389-3493-4489-b9d1-0684be661e73", false, "TestUser2" }
                });
